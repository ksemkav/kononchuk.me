...
import { dateLocales, defaultNS, fallbackLng, Language, languages } from './locales';
...
export function getCurrentSupportedLanguage(i18next: typeof i18n): Language {
  if (languages.includes(i18next.language as Language)) return i18next.language as Language;
