import { addSeconds, differenceInHours, format, startOfToday, Locale } from 'date-fns';
...
export function formatDurationInSecondsAsHHMM(durationInSeconds: number): string {
